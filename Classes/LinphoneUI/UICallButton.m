...
// check address illegal character
    ...
    if( [address length] > 0){
        ...
        int tNumMatchCount = [tNumRegularExpression numberOfMatchesInString:address
                                                                    options:NSMatchingReportProgress
                                                                      range:NSMakeRange(0, address.length)];
        
        
        int tLetterMatchCount = [tLetterRegularExpression numberOfMatchesInString:address options:NSMatchingReportProgress range:NSMakeRange(0, address.length)];
        
        if (tNumMatchCount + tLetterMatchCount == address.length)
        {
