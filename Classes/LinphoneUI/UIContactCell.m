...
- (void)update {
    ...
    NSString *str = (NSString *)lLocalizedFirstName ;
    NSString * str2 = (NSString *)lLocalizedLastName;
    NSString *str3 =  [NSString stringWithFormat:@"%@%@", str, str2];
    
    NSString *newString = [[[str3 lowercaseString] componentsSeparatedByCharactersInSet:[NSCharacterSet lowercaseLetterCharacterSet]] componentsJoinedByString:@""];
    if(newString.length ==0){
        if(lLocalizedFirstName != nil){
            [firstNameLabel setText: (NSString *)lLocalizedFirstName];
            [firstNameLabel setFont:[UIFont fontWithName:@"HelveticaNeue" size:16]];
        }
        else
        ...
        if(lLocalizedLastName != nil){
            ...
            [lastNameLabel setFont:[UIFont fontWithName:@"HelveticaNeue" size:16]];
        }
        else
        ...
        if(lLocalizedFirstName != nil){
            [lastNameLabel setText: (NSString *)lLocalizedFirstName];
            [lastNameLabel setFont:[UIFont fontWithName:@"HelveticaNeue" size:16]];
        }
        else
            [lastNameLabel setText: @""];
        ...
        if(lLocalizedLastName != nil){
            [firstNameLabel setText: (NSString *)lLocalizedLastName];
            [firstNameLabel setFont:[UIFont fontWithName:@"HelveticaNeue" size:16]];
        }
        else
            [firstNameLabel setText: @""];
