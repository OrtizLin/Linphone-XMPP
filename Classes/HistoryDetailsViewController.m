...
- (void)viewDidLoad {
    ...
    UIImage *selfimage =[UIImage imageNamed:@"list_details_default.png"];
    buttonimage=[[UIImageView alloc]initWithImage:selfimage];
    buttonimage.frame = CGRectMake(addressLabel.frame.origin.x+addressLabel.frame.size.width-5,addressLabel.frame.size.height+50,20,20);
