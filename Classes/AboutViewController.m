...
- (void)viewDidLoad {
    [super viewDidLoad];
	[linkLabel setText:NSLocalizedString(@"https://github.com/OrtizLin", nil)];
	...
	[linphoneLabel setText:[NSString stringWithFormat:@"Ortiz"]];
	
    [linphoneIphoneVersionLabel setText:[NSString stringWithFormat:@"Version 2.5.0.1"]];
